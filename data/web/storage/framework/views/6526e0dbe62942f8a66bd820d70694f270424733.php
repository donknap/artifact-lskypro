<div class="pb-6 h-full">
    <input type="file" id="picker" name="file" class="hidden" accept="<?php echo e(implode(',', array_map(fn ($ext) => '.'.$ext, $_group->configs->get(\App\Enums\GroupConfigKey::AcceptedFileSuffixes)))); ?>" multiple>
    ...
    <div class="mb-4 p-4 bg-white rounded-md shadow-custom">
        ...
        <p class="text-gray-500 text-sm">
            最大可上传 <?php echo e(\App\Utils::formatSize($_group->configs->get(\App\Enums\GroupConfigKey::MaximumFileSize) * 1024)); ?> 的图片，上传队列最多
            <?php echo e($_group->configs->get(\App\Enums\GroupConfigKey::ConcurrentUploadNum)); ?>

            张。本站已托管 <?php echo e(\App\Models\Image::query()->count()); ?> 张图片。
        </p>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'preview-modal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'preview-modal']); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('js/blueimp-file-upload/jquery.ui.widget.js')); ?>"></script>
    <script src="<?php echo e(asset('js/blueimp-file-upload/jquery.iframe-transport.js')); ?>"></script>
    <script src="<?php echo e(asset('js/blueimp-file-upload/jquery.fileupload.js')); ?>"></script>
    <script src="<?php echo e(asset('js/blueimp-load-image/load-image.all.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/clipboard/clipboard.min.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php $__env->startPush('scripts'); ?>
    <script>
        let allowSuffixes = <?php echo json_encode($_group->configs->get(\App\Enums\GroupConfigKey::AcceptedFileSuffixes), 15, 512) ?>;
        let maxSize = <?php echo e($_group->configs->get(\App\Enums\GroupConfigKey::MaximumFileSize) * 1024); ?>;
        let pastedAction = '<?php echo e(Auth::check() ? Auth::user()->configs->get(\App\Enums\UserConfigKey::PastedAction) : \App\Enums\PastedAction::Waiting); ?>';
    </script>
    <script>
    ...
    <script>
        ...
        $picker.fileupload({
            ...
            limitConcurrentUploads: <?php echo e($_group->configs->get(\App\Enums\GroupConfigKey::ConcurrentUploadNum, 3)); ?>,
            pasteZone: $(document),
            dropZone: $('#picker-dnd'),
            formData: (form) => {
            ...
            add: (e, data) => { // Return true to continue adding, otherwise terminate
                ...
                let push = function (blob) {
                    ...
                    if (data.from === 'paste' && pastedAction === '<?php echo e(\App\Enums\PastedAction::Upload); ?>') {
                        queue[guid].submit();
                    }
                };
            ...
            progress: (e, data) => {
                ...
                if (response.status) {
                    // 如果开启了自动清除缩略图功能
                    if (<?php echo e((Auth::check() && Auth::user()->configs->get(\App\Enums\UserConfigKey::IsAutoClearPreview)) ? 1 : 0); ?>) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/site/resources/views/components/upload.blade.php ENDPATH**/ ?>