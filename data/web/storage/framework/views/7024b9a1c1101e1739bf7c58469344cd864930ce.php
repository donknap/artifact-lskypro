...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('logo', null, []); ?> 
            <a href="/">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'w-20 h-20 fill-current text-gray-500 text-4xl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-20 h-20 fill-current text-gray-500 text-4xl']); ?>
            ...
            <div class="flex items-center justify-between mt-4">
                <div class="flex items-center text-sm">
                    <?php if(\App\Utils::config(\App\Enums\ConfigKey::IsEnableRegistration)): ?>
                        没有账号？
                        <a class="underline text-gray-600 hover:text-gray-900" href="<?php echo e(route('register')); ?>">
                            注册
                        </a>
                    <?php endif; ?>
                </div>
...
<?php endif; ?>
<?php /**PATH /home/site/resources/views/auth/login.blade.php ENDPATH**/ ?>